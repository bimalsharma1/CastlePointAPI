...
{
    public class GoogleFile : FileBatch
    {
        public GoogleFile() { }
    ...
    public class GoogleFileBatchStatus
    {
        public GoogleFileBatchStatus() { }
        public GoogleFileBatchStatus(string partitionKey, string rowKey)
        {
            this.PartitionKey = partitionKey;
            this.RowKey = rowKey;
        }
